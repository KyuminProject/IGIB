...
<body>
	...
	<!-- menu -->
		...
		<div class="masthead-content text-white" style="margin-bottom: -60px">
		
		
		
            <div class="container-fluid px-4 px-lg-0" id="Main-Container" style="overflow: auto; height: 700px">            
                <h1 class="fst-italic lh-1" id="title">
                    <a href="/" style="color: whitesmoke;">전적 검색 결과</a>
                </h1>    
	    ...
	    $.ajax({
	        ...
	        success: function(response) {
	            ...
	            for (const game of response) {
	                ...
	                gameHtml += '<span class="inner-ward">제어와드 ' + game.visionWardsBoughtInGame + '</span>' 
	                ...
	                blueTableHtml += '<th style="width: 6%;">제어와드</th>'
	                ...
	                redTableHtml += '<th style="width: 6%;">제어와드</th>'
